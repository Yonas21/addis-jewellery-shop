...
const Sidebar = () => {
  return (
    ...
    <div className="row vh-100" style={{marginLeft:"-7%"}}>
                ...
                <ul className="nav nav-pills  flex-sm-column flex-row flex-nowrap flex-shrink-1 flex-sm-grow-0 flex-grow-1 mb-sm-auto mb-0 justify-content-center align-items-center align-items-sm-start" id="menu">
                    ...
                    <li className="dropdown">
                        ...
                        <ul className="dropdown-menu dropdown-menu-dark text-secondary text-small shadow" aria-labelledby="dropdown">
                            ...
                            <li><a className="dropdown-item" href="/admin/update-product">Update Product</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="/admin/checkoutInfo" className="text-secondary text-hover-white nav-link px-sm-0 px-2">
                            <i className="fs-5 bi-people"></i><span className="ms-1 d-none d-sm-inline">Checkout Info</span> </a>
                    </li>
                </ul>
        ...
        <div className="d-flex flex-column h-sm-100">
            <main className="row overflow-auto">
                <div className="ml-4 col-lg-12 pt-4">
                    <Outlet/>                    
                </div>
            </main>
